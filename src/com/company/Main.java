        ...
        switch (chosenVariant1) {
            case "Y":
                ...
                if (!generalTrinagle.trianglesList.isEmpty()) {
                    ...
                    System.out.println("Reserve copy for general triangles is created;");
                }
                if (!equilateral_triangles.equilTrianglesList.isEmpty()) {
                    ...
                    System.out.println("Reserve copy for equilateral triangles is created;");
                }
            ...
            case "N":
                ...
                switch (chosenVariant2) {
                    ...
                    case "N" :
                        ...
                        String chosenVariant3 = scanner2.nextLine().toUpperCase();
